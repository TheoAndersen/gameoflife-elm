...
var _user$project$Game$numberOfNeigbours = F2(
	function (alive, location) {
		return _elm_lang$core$List$sum(
			A2(
				...
				A2(
					_elm_lang$core$List$filter,
					function (loc) {
						return (_elm_lang$core$Native_Utils.cmp(location.row, loc.row - 1) > -1) && ((_elm_lang$core$Native_Utils.cmp(location.row, loc.row + 1) < 1) && ((_elm_lang$core$Native_Utils.cmp(location.col, loc.col - 1) > -1) && ((_elm_lang$core$Native_Utils.cmp(location.col, loc.col + 1) < 1) && (!_elm_lang$core$Native_Utils.eq(location, loc)))));
					},
					alive)));
	});
var _user$project$Game$removeDuplicates = function (list) {
	return _elm_lang$core$List$concat(
		A2(
			_elm_lang$core$List$map,
			function (val) {
				return A2(_elm_lang$core$List$take, 1, val);
			},
			_elm_community$list_extra$List_Extra$group(
				A2(
					...
					function (loc) {
						return A2(
							_elm_lang$core$Basics_ops['++'],
							_elm_lang$core$Basics$toString(loc.row),
							_elm_lang$core$Basics$toString(loc.col));
					},
					list))));
};
var _user$project$Game$groupByOccurenceOfExactly = F2(
		...
		return _elm_lang$core$List$concat(
			A2(
				...
				A2(
					...
					function (value) {
						return _elm_lang$core$Native_Utils.eq(
							_elm_lang$core$List$length(value),
							minSize);
					},
					_elm_community$list_extra$List_Extra$group(
						A2(
...
var _user$project$Game$initModel = function (size) {
	return {
		alive: _elm_lang$core$Native_List.fromArray(
			[]),
		size: size
	};
};
var _user$project$Game$Location = F2(
	function (a, b) {
		return {row: a, col: b};
	});
var _user$project$Game$tick = function (model) {
	var reproduced = A2(
		_user$project$Game$groupByOccurenceOfExactly,
		3,
		_elm_lang$core$List$concat(
			A2(
				...
				function (loc) {
					return _elm_lang$core$Native_List.fromArray(
						[
							A2(_user$project$Game$Location, loc.row - 1, loc.col - 1),
							A2(_user$project$Game$Location, loc.row - 1, loc.col),
							A2(_user$project$Game$Location, loc.row - 1, loc.col + 1),
							A2(_user$project$Game$Location, loc.row, loc.col - 1),
							A2(_user$project$Game$Location, loc.row, loc.col + 1),
							A2(_user$project$Game$Location, loc.row + 1, loc.col - 1),
							A2(_user$project$Game$Location, loc.row + 1, loc.col),
							A2(_user$project$Game$Location, loc.row + 1, loc.col + 1)
	...
	var aliv = A2(
		...
		function (loc) {
			return _elm_lang$core$Native_Utils.eq(
				A2(_user$project$Game$numberOfNeigbours, model.alive, loc),
				2) || _elm_lang$core$Native_Utils.eq(
				A2(_user$project$Game$numberOfNeigbours, model.alive, loc),
				3);
		},
		model.alive);
	var total = _user$project$Game$removeDuplicates(
		A2(_elm_lang$core$Basics_ops['++'], aliv, reproduced));
	return {alive: total, size: model.size};
};
	...
	function (action, model) {
		...
		switch (_p1.ctor) {
			...
			case 'Tick':
				return {
					ctor: '_Tuple2',
					_0: _user$project$Game$tick(model),
...
var _user$project$Game$initialModel = {
	alive: _elm_lang$core$Native_List.fromArray(
		[
			A2(_user$project$Game$Location, 10, 10),
			A2(_user$project$Game$Location, 11, 11),
			A2(_user$project$Game$Location, 10, 12),
			A2(_user$project$Game$Location, 10, 13),
			A2(_user$project$Game$Location, 9, 13),
			A2(_user$project$Game$Location, 20, 20),
			A2(_user$project$Game$Location, 19, 20),
			A2(_user$project$Game$Location, 19, 21),
			A2(_user$project$Game$Location, 19, 22),
			A2(_user$project$Game$Location, 30, 30),
			A2(_user$project$Game$Location, 29, 30),
			A2(_user$project$Game$Location, 31, 30),
			A2(_user$project$Game$Location, 30, 29),
			A2(_user$project$Game$Location, 30, 31)
		]),
	size: 70
};
var _user$project$Game$Model = F2(
	function (a, b) {
		return {alive: a, size: b};
	});
var _user$project$Game$Empty = {ctor: 'Empty'};
var _user$project$Game$Alive = {ctor: 'Alive'};
var _user$project$Game$Press = function (a) {
	return {ctor: 'Press', _0: a};
};
var _user$project$Game$drawCell = F2(
	function (location, cell) {
		var cellFillColor = _elm_lang$core$Native_Utils.eq(cell, _user$project$Game$Alive) ? 'black' : 'white';
		return A2(
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							{ctor: '_Tuple2', _0: 'background-color', _1: cellFillColor},
							{ctor: '_Tuple2', _0: 'display', _1: 'block'},
							{ctor: '_Tuple2', _0: 'float', _1: 'left'}
						])),
					_elm_lang$html$Html_Events$onClick(
					_user$project$Game$Press(location))
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					...
					function (row) {
						return A2(
							...
							function (col) {
								return A2(
									_elm_lang$core$List$member,
									A2(_user$project$Game$Location, row, col),
									model.alive) ? A2(
									_user$project$Game$drawCell,
									A2(_user$project$Game$Location, row, col),
									_user$project$Game$Alive) : A2(
									_user$project$Game$drawCell,
									A2(_user$project$Game$Location, row, col),
									_user$project$Game$Empty);
							},
							_elm_lang$core$Native_List.range(0, model.size));
					},
					_elm_lang$core$Native_List.range(0, model.size)))));
};
var _user$project$Game$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: {ctor: '_Tuple2', _0: _user$project$Game$initialModel, _1: _elm_lang$core$Platform_Cmd$none},
...
var _user$project$Game$Tick = {ctor: 'Tick'};
var _user$project$Game$subscriptions = function (model) {
	return A2(
		_elm_lang$core$Time$every,
		_elm_lang$core$Time$second,
		_elm_lang$core$Basics$always(_user$project$Game$Tick));
};
